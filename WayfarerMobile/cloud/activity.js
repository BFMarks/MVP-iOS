...
var alertMessage = function(request) {
    ...
    if (request.object.get("type") === "comment") {
        if (request.user.get('displayName')) {
            ...
            message = "Someone commented on your Ways.";
        }
//    } else if (request.object.get("type") === "reply") {
//        if (request.user.get('displayName')) {
//            message = request.user.get('displayName') + ': ' + request.object.get('content').trim();
//        } else {
//            message = "Someone replied to your Way.";
//        }
    } else if (request.object.get("type") === "like") {
        if (request.user.get('displayName')) {
            message = request.user.get('displayName') + ' Joined your Way!.';
        } else {
            message = 'Someone joined your Way!';
        }
    ...
    } else if (request.object.get("type") === "invite") {
        if (request.user.get('displayName')) {
            message = request.user.get('displayName') + ' invited you to their Way.';
        } else {
